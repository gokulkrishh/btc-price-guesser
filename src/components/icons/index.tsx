  ...
  return (
    ...
    >
      <path
        fillRule="evenodd"
        clipRule="evenodd"
        d="M11.75 1C5.81294 1 1 5.81294 1 11.75C1 17.6871 5.81294 22.5 11.75 22.5C17.6871 22.5 22.5 17.6871 22.5 11.75C22.5 5.81294 17.6871 1 11.75 1ZM12.5 7.25C12.5 6.83579 12.1642 6.5 11.75 6.5C11.3358 6.5 11 6.83579 11 7.25V7.5H8.75C8.33579 7.5 8 7.83579 8 8.25C8 8.66421 8.33579 9 8.75 9H9V14.5H8.75C8.33579 14.5 8 14.8358 8 15.25C8 15.6642 8.33579 16 8.75 16H11V16.25C11 16.6642 11.3358 17 11.75 17C12.1642 17 12.5 16.6642 12.5 16.25V16H13C14.3807 16 15.5 14.8807 15.5 13.5C15.5 12.8186 15.2274 12.2009 14.7854 11.75C15.2274 11.2991 15.5 10.6814 15.5 10C15.5 8.61929 14.3807 7.5 13 7.5H12.5V7.25ZM10.5 11V9H13C13.5523 9 14 9.44772 14 10C14 10.5523 13.5523 11 13 11H10.5ZM10.5 14.5V12.5H13C13.5523 12.5 14 12.9477 14 13.5C14 14.0523 13.5523 14.5 13 14.5H10.5Z"
        fill="currentColor"
      />
    </svg>
  );
